...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { roles: ['customer', 'seller'], title: 'Giỏ hàng' },
    },
    {
      path: '/checkout',
      name: 'checkout',
    ...
    },
    {
      ...
      meta: { roles: ['customer', 'seller'], title: 'Đơn hàng' },
    },
    {
      path: '/orders/:id',
      name: 'order-detail',
      component: () => import('@/views/customer/OrderDetailView.vue'),
      meta: { roles: ['customer', 'seller'], title: 'Chi tiết đơn' },
    },
    {
      path: '/recommendations',
      name: 'recommendations',
      component: () => import('@/views/customer/RecommendationsView.vue'),
      meta: { roles: ['customer', 'seller'], title: 'Gợi ý' },
    },
    {
      path: '/chatbot',
      name: 'chatbot',
